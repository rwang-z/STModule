# spatial factorization algorithm, CPU version

#' Identify tissue modules, CPU version
#' 
...
#' @export spatial_factorization

spatial_factorization = function(params, profile, dist_mat, maxiter = 2000, track = 10, debugging = 'no', pip_thresh = 1){
